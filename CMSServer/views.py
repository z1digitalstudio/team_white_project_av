...
from .mixins import PublicReadOnlyMixin, BlogOwnerPermissionMixin, PostEditorMixin, LimitBlogChoicesToOwnerMixin, PostOwnerQuerysetViewSetMixin, FilterPostsByBlogViewSetMixin
...
class BlogViewSet(BlogOwnerPermissionMixin, PublicReadOnlyMixin, viewsets.ModelViewSet, LimitBlogChoicesToOwnerMixin):
